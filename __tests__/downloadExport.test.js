...
describe('Android downloads', () => {
  ...
  it('registers the Android MediaStore export package', () => {
    const app = read('android/app/src/main/java/com/anglesya/co3/MainApplication.kt');
    const module = read('android/app/src/main/java/com/anglesya/co3/export/FileExportModule.kt');
