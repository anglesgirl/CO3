...
describe('Android application identity', () => {
  it('uses the requested application ID and native package', () => {
    ...
    const application = read('android/app/src/main/java/com/co3/MainApplication.kt');
    expect(gradle).toContain('namespace "com.ao3.xyz"');
    expect(gradle).toContain('applicationId "com.ao3.xyz"');
    expect(application).toContain('package com.ao3.xyz');
  });
