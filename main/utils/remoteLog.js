...
// ⚠️ 接收端按 app 名分目录落盘：/var/lib/hermes-diagnostics/<app>/<date>.jsonl
// Android 侧原生上报器（android/app/src/main/java/com/co3/Diagnostics.kt）用的是 'co3'，
// 这里必须一致，否则同一个 App 的日志会被劈成两个目录。

const ENDPOINT = 'https://log.anglesgirl.eu.org/v1/events';
// 接收端按 app 分目录落盘：/var/lib/hermes-diagnostics/<app>/<date>.jsonl
const APP = Platform.OS === 'ios' ? 'co3-ios' : 'co3';
